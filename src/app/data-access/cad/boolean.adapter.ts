...
import { booleans as jscadBool } from '@jscad/modeling/src/index';
...
export class BooleanAdapter {
  ...
  union(...parts: Geom3[]): Geom3 {
    ...
    return jscadBool.union(parts as Geom3[]) as Geom3;
  }
  ...
  subtract(a: Geom3, b: Geom3): Geom3 {
    ...
    return jscadBool.subtract(a as Geom3, b as Geom3) as Geom3;
  }
  ...
  intersect(...parts: Geom3[]): Geom3 {
    ...
    return jscadBool.intersect(parts as Geom3[]) as Geom3;
  }
